...
\usepackage{atbegshi}
\usepackage{tikz}
\usetikzlibrary{intersections,decorations.pathreplacing,fit,calc,positioning,shapes.geometric,matrix,spy}
...
% Special Table hacks
\usepackage{array,booktabs,dcolumn,rotating,multirow}

\usepackage{etoolbox}
\robustify\bfseries  % robustify in order to use it in S columns
\preto\chapter\glsresetall  % reset acronyms at the beginning of each chapter
...
%nogroupskip,nopostdot,nomain,nonumberlist
