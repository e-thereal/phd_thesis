...
The NVIDIA CUDA Deep Neural Network library (cuDNN) \cite{chetlur2014} is a
...
% Comparison of used architectures
\begin{itemize}
...
\toprule
\multicolumn{2}{c}{Model} & \multicolumn{2}{c}{Running time [s]\phantom{he}}
& {Speed-up}
\\
& & {Freq} & {cuDNN} &  \\
\midrule
\multirow{5}*{\minitab[l]{$7$-layer CNN\\ used for lesion\\ segmentation}}
...
\multirow{2}*{\minitab[l]{First sconvRBM of \\ the lesion DBN}}
