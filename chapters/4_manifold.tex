...
\tikzstyle{every node}+=[font=\small]
\node
(manifold){\includegraphics[width=\subfigwidth]{figures/MICCAI2014_viridis_p442_d0_full_h16-2}};
...
% {\includegraphics[width=\subfigwidth,height=0.25cm]{figures/viridis_scale}};
% 
